...
describe('GroupService', () => {
  ...
  beforeEach(async () => {
    ...
    const module: TestingModule = await Test.createTestingModule({
      providers: [
        GroupService,
        { provide: getModelToken('Group'), useValue: mockModel },
      ],
    }).compile();
  ...
  describe('findAll', () => {
    it('should return an array of groups', async () => {
      ...
      mockModel.find.mockReturnValue({ exec: jest.fn().mockResolvedValue(groups) });
  ...
  describe('findById', () => {
    it('should return a group by id', async () => {
      mockModel.findById.mockReturnValue({ exec: jest.fn().mockResolvedValue(mockGroup) });
  ...
  describe('update', () => {
    it('should update a group', async () => {
      ...
      mockModel.findByIdAndUpdate.mockReturnValue({ exec: jest.fn().mockResolvedValue(updatedGroup) });
  ...
  describe('createRules', () => {
    it('should create group rules', async () => {
      ...
      const groupWithRules = { ...mockGroup, groupRules: createGroupRulesDto };
      mockModel.findByIdAndUpdate.mockReturnValue({ exec: jest.fn().mockResolvedValue(groupWithRules) });
  ...
  describe('updateRules', () => {
    it('should update group rules', async () => {
      const groupId = 1;
      const updateGroupRulesDto: UpdateGroupRulesDto = { phoneVerification: false };
      const groupWithUpdatedRules = { ...mockGroup, groupRules: updateGroupRulesDto };
      mockModel.findByIdAndUpdate.mockReturnValue({ exec: jest.fn().mockResolvedValue(groupWithUpdatedRules) });
  ...
  describe('addUserToGroup', () => {
    it('should add a user to a group', async () => {
      const addUserToGroupDto: AddUserToGroupDto = { groupId: 1, userId: 1 };
      const groupWithUser = { ...mockGroup, users: [1] };
      mockModel.findByIdAndUpdate.mockReturnValue({ exec: jest.fn().mockResolvedValue(groupWithUser) });
    ...
    it('should throw NotFoundException when group does not exist', async () => {
      const addUserToGroupDto: AddUserToGroupDto = { groupId: 999, userId: 1 };
      mockModel.findByIdAndUpdate.mockReturnValue({ exec: jest.fn().mockResolvedValue(null) });
  ...
  describe('removeUserFromGroup', () => {
    it('should remove a user from a group', async () => {
      const removeUserFromGroupDto: RemoveUserFromGroupDto = { groupId: 1, userId: 1 };
      const groupWithoutUser = { ...mockGroup, users: [] };
      mockModel.findByIdAndUpdate.mockReturnValue({ exec: jest.fn().mockResolvedValue(groupWithoutUser) });
    ...
    it('should throw NotFoundException when group does not exist', async () => {
      const removeUserFromGroupDto: RemoveUserFromGroupDto = { groupId: 999, userId: 1 };
      mockModel.findByIdAndUpdate.mockReturnValue({ exec: jest.fn().mockResolvedValue(null) });
  ...
  describe('deactivate', () => {
    it('should deactivate a group', async () => {
      ...
      mockModel.findByIdAndUpdate.mockReturnValue({ exec: jest.fn().mockResolvedValue(deactivatedGroup) });
      const result = await service.deactivate(groupId);
      expect(result.active).toBe(false);
      expect(mockModel.findByIdAndUpdate).toHaveBeenCalledWith(groupId, { active: false }, { new: true });
    });
  ...
  describe('remove', () => {
    it('should delete a group', async () => {
      const groupId = 1;
      mockModel.findByIdAndDelete.mockReturnValue({ exec: jest.fn().mockResolvedValue(mockGroup) });
